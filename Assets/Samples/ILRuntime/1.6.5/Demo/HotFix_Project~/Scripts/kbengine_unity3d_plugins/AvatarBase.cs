...
namespace KBEngine
{
	...
	public abstract class AvatarBase : Entity
	{
		...
		public abstract void OnGameReady(UInt32 arg1, Byte arg2, Int32 arg3, FRAME_LIST arg4, Int32 arg5); 
		...
		public override void onRemoteMethodCall(MemoryStream stream)
		{
			...
			switch(method.methodUtype)
			{
				...
				case 7:
					...
					break;
				case 5:
					UInt32 OnGameReady_arg1 = stream.readUint32();
					Byte OnGameReady_arg2 = stream.readUint8();
					Int32 OnGameReady_arg3 = stream.readInt32();
					FRAME_LIST OnGameReady_arg4 = ((DATATYPE_FRAME_LIST)method.args[3]).createFromStreamEx(stream);
					Int32 OnGameReady_arg5 = stream.readInt32();
					OnGameReady(OnGameReady_arg1, OnGameReady_arg2, OnGameReady_arg3, OnGameReady_arg4, OnGameReady_arg5);
					break;
				default:
					break;
			};
